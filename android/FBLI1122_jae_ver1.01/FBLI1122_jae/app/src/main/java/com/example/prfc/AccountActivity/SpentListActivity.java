...
public class SpentListActivity extends AppCompatActivity {
    ...
    private class GroupListAdapter extends RecyclerView.Adapter <GroupListAdapter.GroupListViewHolder> {
        ...
        public GroupListAdapter(List<ExpenseList> mBoardList) {
        ...
        class GroupListViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
            ...
            public void onClick(View v){ //클릭됐을때 수정하도록 함.
                ...
                Intent intent = new Intent(v.getContext(), EditSpentList.class);
    ...
    class Connection extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String serverURL = "http://13.209.15.179:50000/user/" + username;
