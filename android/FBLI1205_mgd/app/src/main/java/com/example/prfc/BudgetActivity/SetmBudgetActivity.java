...
public class SetmBudgetActivity extends Activity {
    ...
    public void mOnClose(View V){
        ...
        Log.d("asdasd", "string res = " + res);

        if(res.equals("")){
            finish();
            return;
        }
        Log.d("asdasd", "왜 res가 null이 아니지" + res);

        mDatabase.child(user.getUid()).child("amount").setValue(textView.getText().toString()).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void aVoid) {
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        // Write failed
                        Toast.makeText(getApplicationContext(), "dbupdate = " + "failed" + e.toString(), Toast.LENGTH_SHORT).show();
                        //finish();
                        // ...
                    }
                });
    ...
    class Connection extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            Toast.makeText(SetmBudgetActivity.this, result, Toast.LENGTH_SHORT).show();
        ...
        protected String doInBackground(String... params) {
            ...
            String serverURL = "http://13.209.15.179:50000/user/"+ user.getUid() +"/mbudget";
