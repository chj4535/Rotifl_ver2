...
public class PersonalBudgetActivity extends AppCompatActivity {
    ...
    String item, price, date;
    private RecyclerView mMainRecyclerView;
    private static String TAG = "show spend list";
    private Button GoDutch, SetBudget,ApplySpent, Calculate, Group;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        amount = ref.child(userid).child("amount");
        Budget = (TextView)findViewById(R.id.personalbudget);
        ...
        SetBudget.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PersonalBudgetActivity.this, SetmBudgetActivity.class);
                startActivityForResult(intent, 2);
            }
        });
        ...
        Calculate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PersonalBudgetActivity.this, CalculateActivity.class);
                startActivityForResult(intent, 4);
            }
        });

        //Toast.makeText(getApplicationContext(), "user id = " + currentid, Toast.LENGTH_SHORT).show();
        mMainRecyclerView = findViewById(R.id.mspent_recycler_view);
    ...
    class RequestEdit extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            Toast.makeText(PersonalBudgetActivity.this, result, Toast.LENGTH_SHORT).show();
